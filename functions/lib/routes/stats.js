...
router.use((0, auth_1.rateLimit)(60000, 50)); // 每分钟最多50个请求
/**
 * 获取用户总体统计
 */
...
router.get("/achievements", async (req, res) => {
    ...
    try {
        ...
        const statsDoc = await admin.firestore()
            ...
            .doc("overview")
            .get();
        const achievements = statsDoc.exists ? ((_a = statsDoc.data()) === null || _a === void 0 ? void 0 : _a.achievements) || [] : [];
        // 检查是否有新成就可以解锁
 ...
 * 生成模拟时间统计数据
 */
function generateMockTimeStats(startDate, endDate, groupBy) {
    const stats = [];
